'''
Web interface that mirros the command line application.
...
# Set Flask environment to development mode for detailed error reporting
...
if __name__ == '__main__':
    # Run the Flask application on localhost with debugging enabled
